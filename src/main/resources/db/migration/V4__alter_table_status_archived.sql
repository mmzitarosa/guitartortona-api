...
ALTER TABLE `product` ADD COLUMN `archived` boolean DEFAULT false AFTER `status`;
...
ALTER TABLE `purchase` ADD COLUMN `archived` boolean DEFAULT false AFTER `status`;
...
ALTER TABLE `purchase_item` ADD COLUMN `archived` boolean DEFAULT false AFTER `status`;
